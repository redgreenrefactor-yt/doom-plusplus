...
typedef enum query_target_type_t
{
...
typedef enum query_target_state_t
{
                                   ...
                                   void *user_data)
{
    ...
    {
        printf("(%s) ", GameDescription(static_cast<GameMode_t>(data->gamemode),
