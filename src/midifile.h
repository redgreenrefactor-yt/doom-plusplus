...
typedef enum midi_event_type_t
{
...
typedef enum midi_meta_event_type_t
{
...
typedef struct midi_meta_event_data_t
{
    // Meta event type:
...
typedef struct midi_sysex_event_data_t
{
    // Length:
...
typedef struct midi_channel_event_data_t
{
