...
( int	x,
  ...
  int	height )
{
    wipe_scr_start = reinterpret_cast<pixel_t *>(Z_Malloc(SCREENWIDTH * SCREENHEIGHT * sizeof(*wipe_scr_start), PU_STATIC, NULL));
...
( int	x,
  ...
  int	height )
{
    wipe_scr_end = reinterpret_cast<pixel_t *>(Z_Malloc(SCREENWIDTH * SCREENHEIGHT * sizeof(*wipe_scr_end), PU_STATIC, NULL));
