...
static void R_RaiseVisplanes (visplane_t** vp)
{
	...
	visplanes = reinterpret_cast<visplane_t *>(I_Realloc(visplanes, numvisplanes * sizeof(*visplanes)));
...
//	    dc_texturemid = skytexturemid;
	...
	ds_source = swirling ? reinterpret_cast<byte*>(R_DistortedFlat(lumpnum)) : reinterpret_cast<byte*>(W_CacheLumpNum(lumpnum, PU_STATIC));
