...
static void IncreaseDemoBuffer(void)
{
    ...
    new_demobuffer = reinterpret_cast<byte*>(Z_Malloc(new_length, PU_STATIC, 0));
...
void G_RecordDemo (const char *name)
{
    ...
    demoname = reinterpret_cast<char*>(Z_Malloc(demoname_size, PU_STATIC, NULL));
...
void G_DoPlayDemo (void)
{
    ...
    gameaction = ga_nothing;
    demobuffer = reinterpret_cast<byte*>(W_CacheLumpNum(lumpnum, PU_STATIC));
    demo_p = demobuffer;
