...
void S_Init(int sfxVolume, int musicVolume)
{
    ...
    channels = reinterpret_cast<channel_t *>(I_Realloc(NULL, snd_channels*sizeof(channel_t)));
    sobjs = reinterpret_cast<degenmobj_t *>(I_Realloc(NULL, snd_channels*sizeof(degenmobj_t)));
...
void S_UpdateSndChannels (void)
{
	...
	channels = reinterpret_cast<channel_t *>(I_Realloc(channels, snd_channels * sizeof(channel_t)));
	sobjs = reinterpret_cast<degenmobj_t *>(I_Realloc(sobjs, snd_channels * sizeof(degenmobj_t)));
