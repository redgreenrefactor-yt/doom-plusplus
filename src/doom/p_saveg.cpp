...
char *P_SaveGameFile(int slot)
{
    ...
    if (filename == NULL)
    {
        ...
        filename = reinterpret_cast<char*>(malloc(filename_size));
    }
...
static void saveg_read_mobj_t(mobj_t *str)
{
    ...
    // struct mobj_s* snext;
    str->snext = reinterpret_cast<mobj_t*>(saveg_readp());

    // struct mobj_s* sprev;
    str->sprev = reinterpret_cast<mobj_t *>(saveg_readp());
    ...
    // struct mobj_s* bnext;
    str->bnext = reinterpret_cast<mobj_t *>(saveg_readp());

    // struct mobj_s* bprev;
    str->bprev = reinterpret_cast<mobj_t *>(saveg_readp());

    // struct subsector_s* subsector;
    str->subsector = reinterpret_cast<subsector_t *>(saveg_readp());
    ...
    // mobjinfo_t* info;
    str->info = reinterpret_cast<mobjinfo_t*>(saveg_readp());
    ...
    str->target = reinterpret_cast<mobj_t *>(saveg_readp());
    ...
    str->tracer = reinterpret_cast<mobj_t *>(saveg_readp());
}
...
static void saveg_read_player_t(player_t *str)
{
    ...
    // mobj_t* mo;
    str->mo = reinterpret_cast<mobj_t *>(saveg_readp());
    ...
    // char* message;
    str->message = reinterpret_cast<char *>(saveg_readp());
    ...
    // mobj_t* attacker;
    str->attacker = reinterpret_cast<mobj_t *>(saveg_readp());
